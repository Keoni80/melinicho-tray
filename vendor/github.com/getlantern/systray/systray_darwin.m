...
- (void)setTitle:(NSString *)title {
  // Parche local (melinicho-tray): título con fuente más grande que la
  // estándar de la barra de menús. Dígitos monoespaciados para que el
  // monto no "baile" al actualizarse.
  NSFont *font = [NSFont monospacedDigitSystemFontOfSize:17 weight:NSFontWeightSemibold];
